...
const checkUser = async function(obj) // get user from Users file
{
    let user= await jsonDAL.getUsers();
...
const addUser = async function(obj) // add user to Users file
{
    let user= await jsonDAL.getUsers();
    ...
    let temp={Username: name, Password: psw, CreatedDate: date, NumOfTransactions: num};
...
const updateUser = async function(obj) // update user in Users file
{
    let user= await jsonDAL.getUsers();
...
const deleteUser = async function(obj) // delete user from Users file
{
    let user= await jsonDAL.getUsers();
...
const credits = async function(obj) // get user's credits from Users file
{
...
const sessionUser = async function(obj) // save user to Users file
{
    let user= await jsonDAL.getUsers();
...
module.exports = {users, checkUser, addUser, updateUser, deleteUser, credits, sessionUser};