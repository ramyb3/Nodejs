...
{    
    ...
    if(x>1440) //if next day
    x=x-1440;

    if(x==1440) //24 hours exactly
    {
    ...
    if(h<10 && m>9)
    {
        return "YOU ARE OUT OF CREDITS, COME BACK WITHIN  0" + h + ":" + m + " HOURS";
    }

    if(h>9 && m<10)
    {
        return "YOU ARE OUT OF CREDITS, COME BACK WITHIN  " + h + ":0" + m + " HOURS";
    }
    ...
    if(h<10 && m<10)
    {
        return "YOU ARE OUT OF CREDITS, COME BACK WITHIN 0" + h + ":0" + m + " HOURS";
    }
}
